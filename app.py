...
from coderag.tools import web_fetch, general_reasoning, local_search, read_file
...
st.set_page_config(
    page_title="GitRepo: Agentic Assistant",
    page_icon="",
    layout="wide"
)
...
with st.sidebar:
    ...
    repo_url = st.text_input("Paste GitHub URL", placeholder="https://github.com/owner/repo.git")
        ...
        if not repo_url.strip():
            ...
            with st.spinner("Cloning repository..."):
                try:
                    ...
                    repo_dir, repo_name = clone_repo(repo_url.strip(), clean_if_exists=do_clean)
...
if prompt := st.chat_input("Ask your coding question...", disabled=not client):
    ...
    with st.chat_message("assistant"):
        ...
        st.session_state.conversation_context.append(f"Assistant: {full_response[:300]}...")
